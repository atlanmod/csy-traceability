 ...
 * </p>
 * <ul>
 *   <li>{@link bxml.ConditionType#getAttr <em>Attr</em>}</li>
 *   <li>{@link bxml.ConditionType#getBinaryPred <em>Binary Pred</em>}</li>
 *   <li>{@link bxml.ConditionType#getNaryPred <em>Nary Pred</em>}</li>
 *   <li>{@link bxml.ConditionType#getUnaryPred <em>Unary Pred</em>}</li>
 *   <li>{@link bxml.ConditionType#getQuantifiedPred <em>Quantified Pred</em>}</li>
 *   <li>{@link bxml.ConditionType#getExpComparison <em>Exp Comparison</em>}</li>
 *   <li>{@link bxml.ConditionType#getSet <em>Set</em>}</li>
 * </ul>
 *
 * @see bxml.BxmlPackage#getConditionType()
...
public interface ConditionType extends EObject {
   ...
   * @see bxml.BxmlPackage#getConditionType_Attr()
  ...
  /**
   * Sets the value of the '{@link bxml.ConditionType#getAttr <em>Attr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getConditionType_BinaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.ConditionType#getBinaryPred <em>Binary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getConditionType_NaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.ConditionType#getNaryPred <em>Nary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getConditionType_UnaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.ConditionType#getUnaryPred <em>Unary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getConditionType_QuantifiedPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.ConditionType#getQuantifiedPred <em>Quantified Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getConditionType_ExpComparison()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.ConditionType#getExpComparison <em>Exp Comparison</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setSet(SetType1)
   * @see bxml.BxmlPackage#getConditionType_Set()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.ConditionType#getSet <em>Set</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
