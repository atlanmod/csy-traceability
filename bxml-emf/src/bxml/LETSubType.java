...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>LET Sub Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link bxml.LETSubType#getAttr <em>Attr</em>}</li>
 *   <li>{@link bxml.LETSubType#getVariables <em>Variables</em>}</li>
 *   <li>{@link bxml.LETSubType#getValues <em>Values</em>}</li>
 *   <li>{@link bxml.LETSubType#getThen <em>Then</em>}</li>
 * </ul>
 *
 * @see bxml.BxmlPackage#getLETSubType()
 * @model extendedMetaData="name='LET_Sub_._type' kind='elementOnly'"
 * @generated
 */
public interface LETSubType extends EObject {
  /**
   ...
   * @see bxml.BxmlPackage#getLETSubType_Variables()
  ...
  /**
   * Sets the value of the '{@link bxml.LETSubType#getVariables <em>Variables</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getLETSubType_Values()
   * @model containment="true" required="true"
  ...
  /**
   * Sets the value of the '{@link bxml.LETSubType#getValues <em>Values</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
