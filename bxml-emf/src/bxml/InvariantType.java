...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Invariant Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link bxml.InvariantType#getAttr <em>Attr</em>}</li>
 *   <li>{@link bxml.InvariantType#getBinaryPred <em>Binary Pred</em>}</li>
 *   <li>{@link bxml.InvariantType#getNaryPred <em>Nary Pred</em>}</li>
 *   <li>{@link bxml.InvariantType#getUnaryPred <em>Unary Pred</em>}</li>
 *   <li>{@link bxml.InvariantType#getQuantifiedPred <em>Quantified Pred</em>}</li>
 *   <li>{@link bxml.InvariantType#getExpComparison <em>Exp Comparison</em>}</li>
 *   <li>{@link bxml.InvariantType#getSet <em>Set</em>}</li>
 * </ul>
 *
 * @see bxml.BxmlPackage#getInvariantType()
 * @model extendedMetaData="name='Invariant_._type' kind='elementOnly'"
 * @generated
 */
public interface InvariantType extends EObject {
  /**
   ...
   * @see bxml.BxmlPackage#getInvariantType_Attr()
  ...
  /**
   * Sets the value of the '{@link bxml.InvariantType#getAttr <em>Attr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getInvariantType_BinaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.InvariantType#getBinaryPred <em>Binary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getInvariantType_NaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.InvariantType#getNaryPred <em>Nary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getInvariantType_UnaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.InvariantType#getUnaryPred <em>Unary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getInvariantType_QuantifiedPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.InvariantType#getQuantifiedPred <em>Quantified Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getInvariantType_ExpComparison()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.InvariantType#getExpComparison <em>Exp Comparison</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setSet(SetType1)
   * @see bxml.BxmlPackage#getInvariantType_Set()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.InvariantType#getSet <em>Set</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
