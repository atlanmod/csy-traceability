 ...
 * </p>
 * <ul>
 *   <li>{@link bxml.BodyType#getAttr <em>Attr</em>}</li>
 *   <li>{@link bxml.BodyType#getBinaryPred <em>Binary Pred</em>}</li>
 *   <li>{@link bxml.BodyType#getNaryPred <em>Nary Pred</em>}</li>
 *   <li>{@link bxml.BodyType#getUnaryPred <em>Unary Pred</em>}</li>
 *   <li>{@link bxml.BodyType#getQuantifiedPred <em>Quantified Pred</em>}</li>
 *   <li>{@link bxml.BodyType#getExpComparison <em>Exp Comparison</em>}</li>
 *   <li>{@link bxml.BodyType#getSet <em>Set</em>}</li>
 * </ul>
 *
 * @see bxml.BxmlPackage#getBodyType()
...
public interface BodyType extends EObject {
   ...
   * @see bxml.BxmlPackage#getBodyType_Attr()
  ...
  /**
   * Sets the value of the '{@link bxml.BodyType#getAttr <em>Attr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getBodyType_BinaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.BodyType#getBinaryPred <em>Binary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getBodyType_NaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.BodyType#getNaryPred <em>Nary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getBodyType_UnaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.BodyType#getUnaryPred <em>Unary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getBodyType_QuantifiedPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.BodyType#getQuantifiedPred <em>Quantified Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getBodyType_ExpComparison()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.BodyType#getExpComparison <em>Exp Comparison</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setSet(SetType1)
   * @see bxml.BxmlPackage#getBodyType_Set()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.BodyType#getSet <em>Set</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
