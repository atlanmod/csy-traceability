...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Op Type8</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see bxml.BxmlPackage#getOpType8()
 * @model extendedMetaData="name='op_._8_._type'"
 * @generated
 */
public enum OpType8 implements Enumerator {
  /**
  ...
  /**
   * The '<em><b>29</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #_29_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Rplus</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #RPLUS_VALUE
   * @generated
   * @ordered
   */
  RPLUS(37, "rplus", "rplus"),

  /**
   * The '<em><b>Rminus</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #RMINUS_VALUE
   * @generated
   * @ordered
   */
  RMINUS(38, "rminus", "rminus"),

  /**
   * The '<em><b>Rmul</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #RMUL_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Rdiv</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #RDIV_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Rpow</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #RPOW_VALUE
   * @generated
   ...
   * @ordered
   */
  public static final int _11_VALUE = 11;
   ...
   * @ordered
   */
  public static final int _22_VALUE = 22;
   ...
   * @ordered
   */
  public static final int _23_VALUE = 23;
   ...
   * @ordered
   */
  public static final int _24_VALUE = 24;
   ...
   * @ordered
   */
  public static final int _25_VALUE = 25;
   ...
   * @ordered
   */
  public static final int _26_VALUE = 26;
   ...
   * @ordered
   */
  public static final int _27_VALUE = 27;
   ...
   * @ordered
   */
  public static final int _28_VALUE = 28;
   ...
   * @ordered
   */
  public static final int MOD_VALUE = 29;

  /**
   * The '<em><b>29</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>29</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #_29
   ...
   * @ordered
   */
  public static final int _29_VALUE = 30;
   ...
   * @ordered
   */
  public static final int _33_VALUE = 34;
   ...
   * @ordered
   */
  public static final int _34_VALUE = 35;
   ...
   * @ordered
   */
  public static final int _35_VALUE = 36;

  /**
   * The '<em><b>Rplus</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Rplus</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #RPLUS
   ...
   * @ordered
   */
  public static final int RPLUS_VALUE = 37;

  /**
   * The '<em><b>Rminus</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Rminus</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #RMINUS
   ...
   * @ordered
   */
  public static final int RMINUS_VALUE = 38;

  /**
   * The '<em><b>Rmul</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Rmul</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #RMUL
   ...
   * @ordered
   */
  public static final int RMUL_VALUE = 39;

  /**
   * The '<em><b>Rdiv</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Rdiv</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #RDIV
   ...
   * @ordered
   */
  public static final int RDIV_VALUE = 40;

  /**
   * The '<em><b>Rpow</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Rpow</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #RPOW
   ...
   * @ordered
   */
  public static final int RPOW_VALUE = 41;

  /**
   * An array of all the '<em><b>Op Type8</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final OpType8[] VALUES_ARRAY =
    new OpType8[] {
      __,
      _1,
      _2,
  ...
  /**
   * A public read-only list of all the '<em><b>Op Type8</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final List<OpType8> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Op Type8</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public static OpType8 get(String literal) {
    for (int i = 0; i < VALUES_ARRAY.length; ++i) {
      OpType8 result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Op Type8</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param name the name.
   * @return the matching enumerator or <code>null</code>.
   * @generated
   */
  public static OpType8 getByName(String name) {
    for (int i = 0; i < VALUES_ARRAY.length; ++i) {
      OpType8 result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Op Type8</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public static OpType8 get(int value) {
    switch (value) {
      ...
      case RPLUS_VALUE: return RPLUS;
      case RMINUS_VALUE: return RMINUS;
      case RMUL_VALUE: return RMUL;
      case RDIV_VALUE: return RDIV;
      case RPOW_VALUE: return RPOW;
    }
    return null;
  }
   ...
   * @generated
   */
  private OpType8(int value, String name, String literal) {
    this.value = value;
    this.name = name;
