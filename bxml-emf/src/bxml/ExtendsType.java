 ...
 * </p>
 * <ul>
 *   <li>{@link bxml.ExtendsType#getAttr <em>Attr</em>}</li>
 *   <li>{@link bxml.ExtendsType#getReferencedMachine <em>Referenced Machine</em>}</li>
 * </ul>
 *
 * @see bxml.BxmlPackage#getExtendsType()
 * @model extendedMetaData="name='Extends_._type' kind='elementOnly'"
 * @generated
 */
public interface ExtendsType extends EObject {
   ...
   * @see bxml.BxmlPackage#getExtendsType_Attr()
  ...
  /**
   * Sets the value of the '{@link bxml.ExtendsType#getAttr <em>Attr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getExtendsType_ReferencedMachine()
