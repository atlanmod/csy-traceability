 ...
 * </p>
 * <ul>
 *   <li>{@link bxml.PredType#getAttr <em>Attr</em>}</li>
 *   <li>{@link bxml.PredType#getBinaryPred <em>Binary Pred</em>}</li>
 *   <li>{@link bxml.PredType#getNaryPred <em>Nary Pred</em>}</li>
 *   <li>{@link bxml.PredType#getUnaryPred <em>Unary Pred</em>}</li>
 *   <li>{@link bxml.PredType#getQuantifiedPred <em>Quantified Pred</em>}</li>
 *   <li>{@link bxml.PredType#getExpComparison <em>Exp Comparison</em>}</li>
 *   <li>{@link bxml.PredType#getSet <em>Set</em>}</li>
 * </ul>
 *
 * @see bxml.BxmlPackage#getPredType()
 * @model extendedMetaData="name='Pred_._type' kind='elementOnly'"
 * @generated
 */
public interface PredType extends EObject {
   ...
   * @see bxml.BxmlPackage#getPredType_Attr()
  ...
  /**
   * Sets the value of the '{@link bxml.PredType#getAttr <em>Attr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getPredType_BinaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.PredType#getBinaryPred <em>Binary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getPredType_NaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.PredType#getNaryPred <em>Nary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getPredType_UnaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.PredType#getUnaryPred <em>Unary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getPredType_QuantifiedPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.PredType#getQuantifiedPred <em>Quantified Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getPredType_ExpComparison()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.PredType#getExpComparison <em>Exp Comparison</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setSet(SetType1)
   * @see bxml.BxmlPackage#getPredType_Set()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.PredType#getSet <em>Set</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
