 ...
 *   <li>{@link bxml.StructType#getTypref <em>Typref</em>}</li>
 * </ul>
 *
 * @see bxml.BxmlPackage#getStructType()
 * @model extendedMetaData="name='Struct_type' kind='elementOnly'"
 * @generated
 */
public interface StructType extends EObject {
   ...
   * @see bxml.BxmlPackage#getStructType_Typref()
  ...
  /**
   * Sets the value of the '{@link bxml.StructType#getTypref <em>Typref</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
