 ...
 * </p>
 * <ul>
 *   <li>{@link bxml.GuardType#getAttr <em>Attr</em>}</li>
 *   <li>{@link bxml.GuardType#getBinaryPred <em>Binary Pred</em>}</li>
 *   <li>{@link bxml.GuardType#getNaryPred <em>Nary Pred</em>}</li>
 *   <li>{@link bxml.GuardType#getUnaryPred <em>Unary Pred</em>}</li>
 *   <li>{@link bxml.GuardType#getQuantifiedPred <em>Quantified Pred</em>}</li>
 *   <li>{@link bxml.GuardType#getExpComparison <em>Exp Comparison</em>}</li>
 *   <li>{@link bxml.GuardType#getSet <em>Set</em>}</li>
 * </ul>
 *
 * @see bxml.BxmlPackage#getGuardType()
 * @model extendedMetaData="name='Guard_._type' kind='elementOnly'"
 * @generated
 */
public interface GuardType extends EObject {
   ...
   * @see bxml.BxmlPackage#getGuardType_Attr()
  ...
  /**
   * Sets the value of the '{@link bxml.GuardType#getAttr <em>Attr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getGuardType_BinaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.GuardType#getBinaryPred <em>Binary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getGuardType_NaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.GuardType#getNaryPred <em>Nary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getGuardType_UnaryPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.GuardType#getUnaryPred <em>Unary Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getGuardType_QuantifiedPred()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.GuardType#getQuantifiedPred <em>Quantified Pred</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bxml.BxmlPackage#getGuardType_ExpComparison()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.GuardType#getExpComparison <em>Exp Comparison</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setSet(SetType1)
   * @see bxml.BxmlPackage#getGuardType_Set()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link bxml.GuardType#getSet <em>Set</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
