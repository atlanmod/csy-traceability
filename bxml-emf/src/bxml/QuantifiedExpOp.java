...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Quantified Exp Op</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see bxml.BxmlPackage#getQuantifiedExpOp()
 * @model extendedMetaData="name='quantified_exp_op'"
 * @generated
 */
public enum QuantifiedExpOp implements Enumerator {
  /**
  ...
  /**
   * An array of all the '<em><b>Quantified Exp Op</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final QuantifiedExpOp[] VALUES_ARRAY =
    new QuantifiedExpOp[] {
      __,
      SIGMA,
      PI,
  ...
  /**
   * A public read-only list of all the '<em><b>Quantified Exp Op</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final List<QuantifiedExpOp> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Quantified Exp Op</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public static QuantifiedExpOp get(String literal) {
    for (int i = 0; i < VALUES_ARRAY.length; ++i) {
      QuantifiedExpOp result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Quantified Exp Op</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param name the name.
   * @return the matching enumerator or <code>null</code>.
   * @generated
   */
  public static QuantifiedExpOp getByName(String name) {
    for (int i = 0; i < VALUES_ARRAY.length; ++i) {
      QuantifiedExpOp result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Quantified Exp Op</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public static QuantifiedExpOp get(int value) {
    switch (value) {
   ...
   * @generated
   */
  private QuantifiedExpOp(int value, String name, String literal) {
    this.value = value;
    this.name = name;
