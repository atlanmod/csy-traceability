...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Op Type3</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see bxml.BxmlPackage#getOpType3()
 * @model extendedMetaData="name='op_._3_._type'"
 * @generated
 */
public enum OpType3 implements Enumerator {
  /**
  ...
  /**
   * The '<em><b>Rgt</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #RGT_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Rge</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #RGE_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Rgt</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Rgt</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #RGT
   ...
   * @ordered
   */
  public static final int RGT_VALUE = 12;
   ...
   * @ordered
   */
  public static final int RLT_VALUE = 13;
   ...
   * @ordered
   */
  public static final int RLE_VALUE = 14;

  /**
   * The '<em><b>Rge</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Rge</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #RGE
   ...
   * @ordered
   */
  public static final int RGE_VALUE = 15;

  /**
   * An array of all the '<em><b>Op Type3</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final OpType3[] VALUES_ARRAY =
    new OpType3[] {
      __,
      _1,
      _2,
  ...
  /**
   * A public read-only list of all the '<em><b>Op Type3</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final List<OpType3> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Op Type3</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public static OpType3 get(String literal) {
    for (int i = 0; i < VALUES_ARRAY.length; ++i) {
      OpType3 result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Op Type3</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param name the name.
   * @return the matching enumerator or <code>null</code>.
   * @generated
   */
  public static OpType3 getByName(String name) {
    for (int i = 0; i < VALUES_ARRAY.length; ++i) {
      OpType3 result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Op Type3</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public static OpType3 get(int value) {
    switch (value) {
      ...
      case RGT_VALUE: return RGT;
      case RLT_VALUE: return RLT;
      case RLE_VALUE: return RLE;
      case RGE_VALUE: return RGE;
    }
    return null;
  }
   ...
   * @generated
   */
  private OpType3(int value, String name, String literal) {
    this.value = value;
    this.name = name;
