 ...
 * </p>
 * <ul>
 *   <li>{@link bxml.impl.NameTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NameTypeImpl extends MinimalEObjectImpl.Container implements NameType {
  ...
  protected EClass eStaticClass() {
    return BxmlPackage.eINSTANCE.getNameType();
  }
  ...
  public EList<IdentifierType> getId() {
    if (id == null) {
      id = new EObjectContainmentEList<IdentifierType>(IdentifierType.class, this, BxmlPackage.NAME_TYPE__ID);
    }
    return id;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case BxmlPackage.NAME_TYPE__ID:
