...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Call Paramaters Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getExp <em>Exp</em>}</li>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getBinaryExp <em>Binary Exp</em>}</li>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getNaryExp <em>Nary Exp</em>}</li>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getBooleanLiteral <em>Boolean Literal</em>}</li>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getBooleanExp <em>Boolean Exp</em>}</li>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getEmptySet <em>Empty Set</em>}</li>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getEmptySeq <em>Empty Seq</em>}</li>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getIntegerLiteral <em>Integer Literal</em>}</li>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getQuantifiedExp <em>Quantified Exp</em>}</li>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getQuantifiedSet <em>Quantified Set</em>}</li>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getSTRINGLiteral <em>STRING Literal</em>}</li>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getUnaryExp <em>Unary Exp</em>}</li>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getStruct <em>Struct</em>}</li>
 *   <li>{@link bxml.impl.CallParamatersTypeImpl#getRecord <em>Record</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CallParamatersTypeImpl extends MinimalEObjectImpl.Container implements CallParamatersType {
  /**
   ...
   * @generated
   */
  protected CallParamatersTypeImpl() {
    super();
  }
  ...
  protected EClass eStaticClass() {
    return BxmlPackage.eINSTANCE.getCallParamatersType();
  }
  ...
  public FeatureMap getExp() {
    if (exp == null) {
      exp = new BasicFeatureMap(this, BxmlPackage.CALL_PARAMATERS_TYPE__EXP);
    }
    return exp;
  }
  ...
  public EList<BinaryExpressionType> getBinaryExp() {
    return getExp().list(BxmlPackage.eINSTANCE.getCallParamatersType_BinaryExp());
  }
  ...
  public EList<NaryExpType> getNaryExp() {
    return getExp().list(BxmlPackage.eINSTANCE.getCallParamatersType_NaryExp());
  }
  ...
  public EList<IdentifierType> getBooleanLiteral() {
    return getExp().list(BxmlPackage.eINSTANCE.getCallParamatersType_BooleanLiteral());
  }
  ...
  public EList<PredicateType> getBooleanExp() {
    return getExp().list(BxmlPackage.eINSTANCE.getCallParamatersType_BooleanExp());
  }
  ...
  public EList<TerminalType> getEmptySet() {
    return getExp().list(BxmlPackage.eINSTANCE.getCallParamatersType_EmptySet());
  }
  ...
  public EList<TerminalType> getEmptySeq() {
    return getExp().list(BxmlPackage.eINSTANCE.getCallParamatersType_EmptySeq());
  }
  ...
  public EList<IdentifierType> getId() {
    return getExp().list(BxmlPackage.eINSTANCE.getCallParamatersType_Id());
  }
  ...
  public EList<LiteralType> getIntegerLiteral() {
    return getExp().list(BxmlPackage.eINSTANCE.getCallParamatersType_IntegerLiteral());
  }
  ...
  public EList<QuantifiedExpType> getQuantifiedExp() {
    return getExp().list(BxmlPackage.eINSTANCE.getCallParamatersType_QuantifiedExp());
  }
  ...
  public EList<QuantifiedSetType> getQuantifiedSet() {
    return getExp().list(BxmlPackage.eINSTANCE.getCallParamatersType_QuantifiedSet());
  }
  ...
  public EList<StringLiteralType> getSTRINGLiteral() {
    return getExp().list(BxmlPackage.eINSTANCE.getCallParamatersType_STRINGLiteral());
  }
  ...
  public EList<UnaryExpressionType> getUnaryExp() {
    return getExp().list(BxmlPackage.eINSTANCE.getCallParamatersType_UnaryExp());
  }
  ...
  public EList<StructType> getStruct() {
    return getExp().list(BxmlPackage.eINSTANCE.getCallParamatersType_Struct());
  }
  ...
  public EList<RecordType> getRecord() {
    return getExp().list(BxmlPackage.eINSTANCE.getCallParamatersType_Record());
  }
