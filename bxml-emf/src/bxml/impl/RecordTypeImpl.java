...
public class RecordTypeImpl extends MinimalEObjectImpl.Container implements RecordType {
  ...
  protected EClass eStaticClass() {
    return BxmlPackage.eINSTANCE.getRecordType();
  }
  ...
  public void setAttr(AttrType newAttr) {
    if (newAttr != attr) {
      ...
      if (attr != null)
        msgs = ((InternalEObject)attr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BxmlPackage.RECORD_TYPE__ATTR, null, msgs);
      if (newAttr != null)
        msgs = ((InternalEObject)newAttr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BxmlPackage.RECORD_TYPE__ATTR, null, msgs);
      msgs = basicSetAttr(newAttr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BxmlPackage.RECORD_TYPE__ATTR, newAttr, newAttr));
  }
  ...
  public EList<RecordItemType> getRecordItem() {
    if (recordItem == null) {
      recordItem = new EObjectContainmentEList<RecordItemType>(RecordItemType.class, this, BxmlPackage.RECORD_TYPE__RECORD_ITEM);
    }
    return recordItem;
  }
