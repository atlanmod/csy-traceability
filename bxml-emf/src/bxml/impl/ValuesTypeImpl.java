 ...
 * </p>
 * <ul>
 *   <li>{@link bxml.impl.ValuesTypeImpl#getAttr <em>Attr</em>}</li>
...
public class ValuesTypeImpl extends MinimalEObjectImpl.Container implements ValuesType {
  ...
  public NotificationChain basicSetAttr(AttrType newAttr, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BxmlPackage.VALUES_TYPE__ATTR, oldAttr, newAttr);
  ...
  public void setAttr(AttrType newAttr) {
    if (newAttr != attr) {
      ...
      if (attr != null)
        msgs = ((InternalEObject)attr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BxmlPackage.VALUES_TYPE__ATTR, null, msgs);
      if (newAttr != null)
        msgs = ((InternalEObject)newAttr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BxmlPackage.VALUES_TYPE__ATTR, null, msgs);
      msgs = basicSetAttr(newAttr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BxmlPackage.VALUES_TYPE__ATTR, newAttr, newAttr));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case BxmlPackage.VALUES_TYPE__ATTR:
