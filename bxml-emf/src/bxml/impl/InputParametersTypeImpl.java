 ...
 * </p>
 * <ul>
 *   <li>{@link bxml.impl.InputParametersTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputParametersTypeImpl extends MinimalEObjectImpl.Container implements InputParametersType {
  ...
  protected EClass eStaticClass() {
    return BxmlPackage.eINSTANCE.getInputParametersType();
  }
  ...
  public EList<IdentifierType> getId() {
    if (id == null) {
      id = new EObjectContainmentEList<IdentifierType>(IdentifierType.class, this, BxmlPackage.INPUT_PARAMETERS_TYPE__ID);
    }
    return id;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case BxmlPackage.INPUT_PARAMETERS_TYPE__ID:
