 ...
 * </p>
 * <ul>
 *   <li>{@link bxml.impl.ParametersType1Impl#getAttr <em>Attr</em>}</li>
...
public class ParametersType1Impl extends MinimalEObjectImpl.Container implements ParametersType1 {
  ...
  public NotificationChain basicSetAttr(AttributesType newAttr, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BxmlPackage.PARAMETERS_TYPE1__ATTR, oldAttr, newAttr);
  ...
  public void setAttr(AttributesType newAttr) {
    if (newAttr != attr) {
      ...
      if (attr != null)
        msgs = ((InternalEObject)attr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BxmlPackage.PARAMETERS_TYPE1__ATTR, null, msgs);
      if (newAttr != null)
        msgs = ((InternalEObject)newAttr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BxmlPackage.PARAMETERS_TYPE1__ATTR, null, msgs);
      msgs = basicSetAttr(newAttr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BxmlPackage.PARAMETERS_TYPE1__ATTR, newAttr, newAttr));
  }
  ...
  public EList<IdentifierType> getId() {
    if (id == null) {
      id = new EObjectContainmentEList<IdentifierType>(IdentifierType.class, this, BxmlPackage.PARAMETERS_TYPE1__ID);
    }
    return id;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case BxmlPackage.PARAMETERS_TYPE1__ATTR:
