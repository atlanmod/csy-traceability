 ...
 * </p>
 * <ul>
 *   <li>{@link bxml.impl.AttributesTypeImpl#getAny <em>Any</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributesTypeImpl extends MinimalEObjectImpl.Container implements AttributesType {
  ...
  protected EClass eStaticClass() {
    return BxmlPackage.eINSTANCE.getAttributesType();
  }
  ...
  public FeatureMap getAny() {
    if (any == null) {
      any = new BasicFeatureMap(this, BxmlPackage.ATTRIBUTES_TYPE__ANY);
    }
    return any;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case BxmlPackage.ATTRIBUTES_TYPE__ANY:
